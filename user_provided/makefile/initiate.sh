...
echo "    [ ] DFRobot_AS7341 - DO NOT use the stock Library Manager version."
echo "          Copy user_provided/arduino/libraries/DFRobot_AS7341/ into your"
echo "          sketchbook's libraries/ folder instead (it has a timeout patch"
echo "          for a hang bug that caused a multi-hour data gap - see"
echo "          PATCH_NOTES.md in that folder)."
